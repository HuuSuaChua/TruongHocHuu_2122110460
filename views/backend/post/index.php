                        ...
                        <tr class="datarow">
                           ...
                           <td>
                              ...
                              <?php if($item->status == 1): ?>
                                 ...
                                 <?else: ?>
                                 <a  class="text-warning"  href="index.php?option=post&cat=edit&id=<?= $item->id;?>">Chỉnh sửa</a> |
                                 <a  class="text-warning"  href="index.php?option=post&cat=show&id=<?= $item->id;?>">Chi tiết</a> |
                                 <a  class="text-danger"  href="index.php?option=post&cat=delete&id=<?= $item->id;?>">Xoá</a>
                                 <?php endif; ?>
                              </div>
                           </td>
                           <td><?= $item->type; ?></td>
