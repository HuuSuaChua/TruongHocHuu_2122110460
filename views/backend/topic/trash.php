                           ...
                           <?php if(count($list) > 0) : ?>
                              ...
                              <tr class="datarow">
                                 ...
                                 <td>
                                    ...
                                    <a class="text-danger" href="index.php?option=topic&cat=restore&id=<?= $item->id;?>"><i class="fas fa-undo"></i> Khôi Phục</a>  
                                    <a class="text-danger" href="index.php?option=topic&cat=destroy&id=<?= $item->id;?>"><i class="fas fa-trash"></i></i> Xoá</a>  
                                    </div>
                                 </td>
                                 <td><?= $item->slug; ?></td>
                              </tr>
