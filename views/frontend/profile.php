      ...
      <div class="container">
         <div class="row">
            ...
            <div class="col-md-9 order-1 order-md-2">
               <h1 class="fs-2 text-main bg-danger">Thông tin tài khoản</h1>
               <table class="table table-borderless">
                  <tr>
                     <td style="width:20%;">Tên tài khoản</td>
                     <td>Trương Học Hữu</td>
                  </tr>
                  <tr>
                     <td style="width:20%;">Tên đăng nhập</td>
                     <td>truonghochuu <a href="profile_changepassword.html">Đổi mật khẩu</a> </td>
                  </tr>
                  <tr>
                     <td style="width:20%;">Email</td>
                     <td>truonghochuuken@gmail.com</td>
                  </tr>
                  <tr>
                  ...
                  <tr>
                     ...
                     <td>Số 46a - Đường 22 - Phước Long B - Quận 9 <a href="profile_edit.html">Đổi địa chỉ</a> </td>
                  </tr>
               </table>
            </div>
         </div>
