      ...
      <div class="container">
         <div class="row">
            <div class="col-md-6">
               ...
               <p class="text-info" >Bạn có tài khoản chưa? <a href="index.php?option=customer&login=true">Đăng nhập</a></p>
               <?php if(isset($_SESSION["iscustom"])): ?>
               <div class="mb-3">
                  <label class="text-info" for="name">Họ tên</label>
                  <input type="text" name="name" id="name" value="<?=$customer->name;?>" class="form-control" placeholder="Nhập họ tên" readonly>
               </div>
               <div class="mb-3">
                  <label class="text-info" for="phone">Điện thoại</label>
               ...
               <div class="mb-3">
                        <label class="text-info" for="address">Địa chỉ</label>
               ...
               <div class="thanhtoan mb-4 bg-light">
